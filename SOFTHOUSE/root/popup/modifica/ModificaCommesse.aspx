<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModificaCommesse.aspx.cs" Inherits="ModificaCommesse" %>
        ...
        <div id="mod" runat="server">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <%--di proposito lasciato vuoto--%>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:RadioButton ID="rdb1" runat="server" GroupName="Commessa" Text="Aperta" />
                        <asp:RadioButton ID="rdb2" runat="server" GroupName="Commessa" Checked="True" Text="Chiusa" />
                    </td>
                    <td>
